...
Boid.prototype.create_geometry = function() {
    ...
    **/
    ...
    this.geometry = new THREE.BoxGeometry(this.radius, 25, 25);
...
Boid.prototype.create_material = function() {
    ...
    **/
    ...
    this.material = new THREE.MeshPhongMaterial({color: this.color, specular: 0x333333, shininess: 0.9, transparent: true, opacity: 0.75});
